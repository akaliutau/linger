          ...
          {shareUrl ? (
            <div className="pipeline-box generated">
              ...
              <div className="pipeline-actions">
                <a className="primary-button pipeline-link-button" href={shareUrl} target="_blank" rel="noreferrer">
                  Open share link
                </a>
                <button className="secondary-button pipeline-link-button" type="button" onClick={onReset}>
                  Start again
                </button>
              </div>
            </div>
